...
# Initialize the Laundromat database
# "The Laundromat" - Premium cleaning supplies distribution

set -e

DB_NAME="laundromat"
DB_USER_ADMIN="laundry_admin"
DB_USER_READONLY="laundry_viewer"
DB_PASSWORD="InsecureDbPass"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
SQL_FILE="${SCRIPT_DIR}/laundromat_db.sql"

echo "🧼 The Laundromat Database Setup"
echo "================================="
echo ""
...
echo ""
echo "✅ Laundromat database initialized successfully!"
echo ""
...
echo "  SELECT * FROM products WHERE purity_grade LIKE '%99%';"
echo "  SELECT * FROM high_value_deliveries;"
echo "  SELECT * FROM premium_customers;"
echo ""
